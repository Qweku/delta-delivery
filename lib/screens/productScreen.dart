...
class ProductScreen extends StatefulWidget {
  final int? tag;
  const ProductScreen({Key? key, this.tag}) : super(key: key);
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ProductModel productItems = ProductModel(
                                    prodColor:products.productColor[index],
                                    prodImage: products.productImages[index],
                                    prodName:products.productName[index],
                                    prodPrice:products.prices[index]
                                  );
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                ...
                                child: Container(
                                    ...
                                    child: ProductItem(
                                      bkgColor:products.productColor[index],
                                      image: products.productImages[index],
                                      productName: products.productName[index],
